...
repo contains analyses of my plugins, the plugin files themselves, descriptions of what works where, links to useful sources, etc
...
you can also hit me up on tg ([@jaxbastard](https://t.me/jaxbastard)) and i'll add your plugin with its analysis
...
## 🔗 RU: полезные ссылки / EN: useful links
...
<sub>apache-2.0 · ExteraGram 12.5.1+ · AyuGram based on it</sub>
